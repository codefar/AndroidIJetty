...
public class AndroidContextDeployer extends AbstractLifeCycle {
    ...
    protected class ScannerListener implements Scanner.DiscreteListener {
         ...
         * 
         * @see org.mortbay.util.Scanner.FileAddedListener#fileAdded(String)
         */
         ...
         * 
         * @see org.mortbay.util.Scanner.FileChangedListener#fileChanged(String)
         */
         ...
         * Handle an undeploy.
         * 
         * @see org.mortbay.util.Scanner.FileRemovedListener#fileRemoved(String)
         */
